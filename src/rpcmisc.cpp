...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <PolishSexIndustryaddress>\n"
            "Return information about <PolishSexIndustryaddress>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <PolishSexIndustrypubkey>\n"
            "Return information about <PolishSexIndustrypubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <PolishSexIndustryaddress> <signature> <message>\n"
