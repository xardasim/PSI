...
void ThreadIRCSeed()
{
    ...
    RenameThread("PolishSexIndustry-ircseed");
...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #PolishSexIndustrycoinTEST\r");
            Send(hSocket, "WHO #PolishSexIndustrycoinTEST\r");
        } else
        {
	    LogPrintf("JOIN #PolishSexIndustrycoin\n");
            // randomly join #PolishSexIndustrycoin00-#PolishSexIndustrycoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #PolishSexIndustrycoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #PolishSexIndustrycoin%02d\r", channel_number).c_str());
        };
