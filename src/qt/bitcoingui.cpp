...
{
    resize(700, 550);
    setWindowTitle(tr("PolishSexIndustry") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a PSI address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&PSI Masternodes"), this);
    masternodeManagerAction->setToolTip(tr("Show PSI Masternode Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About PolishSexIndustry"), this);
    aboutAction->setToolTip(tr("Show information about PolishSexIndustry"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for PolishSexIndustry"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("PolishSexIndustry client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::setModel(WalletModel *walletModel)
{
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PolishSexIndustry client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PolishSexIndustry network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    else
    {
        ...
        progressBarLabel->setText(tr(clientModel->isImporting() ? "Importing blocks..." : "<span style=color:black>Synchronizing with network...</span>"));
...
{
    QString strTitle = tr("PolishSexIndustry") + " - ";
...
void BitcoinGUI::gotoOverviewPage()
{
	...
	overviewPage->setStyleSheet("border: 1px solid rgba(240,240,240,0)");
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid PSI address or malformed URI parameters."));
    }
...
void BitcoinGUI::handleURI(QString strURI)
{
    ...
    if (sendCoinsPage->handleURI(strURI))
    {
        ...
        notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid PolishSexIndustry address or malformed URI parameters."));
}
