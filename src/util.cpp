...
#else
    const char* pszModule = "PolishSexIndustry";
#endif
    if (pex)
        return strprintf(
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\PolishSexIndustry
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\PolishSexIndustry
    // Mac: ~/Library/Application Support/PolishSexIndustry
    // Unix: ~/.PolishSexIndustry
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PolishSexIndustry";
#else
    fs::path pathRet;
    ...
    return pathRet / "PolishSexIndustry";
#else
    // Unix
    return pathRet / ".PolishSexIndustry";
#endif
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "PolishSexIndustry.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "PolishSexIndustryd.pid"));
